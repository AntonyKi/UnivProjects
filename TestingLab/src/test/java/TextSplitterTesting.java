...
public class TextSplitterTesting {
    ...
    public void correctFileReading(){
        ...
        try {
            ...
            MatcherAssert.assertThat(ts.getText(instr),is(equalTo("One/ Two two threE")));
    ...
    public TextSplitterTesting(String testText, String longWord, String shortWord, Integer limit){
    ...
    public void lengthLimit(){
        ...
        ts.setText(testText);
        assertFalse(ts.splitText().contains(longWord)&&!ts.splitText().contains(shortWord));
    }
